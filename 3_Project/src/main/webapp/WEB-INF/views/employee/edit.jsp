      ...
      <div align="center" id="editDiv">
         <table>
            <tr>
               ...
               <td><input type="text" name="id" id="id" class="editInput" size="25" readonly style="background: lightgray"
            ...
            <tr>
               ...
               <td><input type="text" name="name" id="name" class="editInput" size="25" value="${loginUser.empName}" required></td>
            </tr>
            <tr>
               <td><label for="job">직업</label></td>
               <td><input type="text" name="job" id="job" class="editInput" size="25" value="${loginUser.job}" required></td>
            </tr>
            <tr>
               <td><label for="sal">급여</label></td>
               <td><input type="number" name="sal" class="editInput" id="sal" size="25"  value="${loginUser.sal}" required></td>
            </tr>
            <tr>
